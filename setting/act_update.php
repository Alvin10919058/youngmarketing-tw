<?php
    ...
    if(isset($_POST["submitbtn"]) && isset($_FILES["actfile"])){
    ...
    <body>
        ...
        <div class="body-wrapper">
            <div class="container-fluid">
                <div class="show-content-1" id="act_update">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data"
                          action="act_update.php" method="post">
                        <div class="form-group-lg">
                            <span class="label label-success text-1">行銷案例-臉書活動修改</span>
                            <div class="text-center divide30 text-2">編號:<?php print "$id";?></div>
                        </div>
                        <div class="form-group">
                            <label for="actfile" class="col-sm-2 control-label">圖片</label>
                            <div class="col-sm-10">
